...
keymap.set("n", "<leader>sh", "<C-w>s", { desc = "Split window hrizontally" })
...
keymap.set("n", "bl", "<cmd>bnext<CR>", { desc = "Goto next buffer" })
keymap.set("n", "bh", "<cmd>bprevious<CR>", { desc = "Goto previous buffer" })
